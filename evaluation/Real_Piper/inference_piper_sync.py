...
REAL_LIFT2_DIR = THIS_DIR.parent / "Real_Lift2"
...
class PiperRosOperator:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        rospy.init_node("cubev2_piper_sync_client", anonymous=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sync CubeV2 real_piper ROS1 deployment client.")
...
def signal_handler(_sig: int, _frame: Any) -> None:
    print("\n[CubeV2-Piper] Caught Ctrl+C, shutting down.")
