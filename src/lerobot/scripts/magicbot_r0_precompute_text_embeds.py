...
from lerobot.policies.MagicBot_R0.core.models.wan22.helpers.loader import (
    _load_registered_model,
    _resolve_configs,
)
from lerobot.policies.MagicBot_R0.core.models.wan22.wan_video_text_encoder import HuggingfaceTokenizer
from lerobot.policies.MagicBot_R0.text_cache import (
    build_magicbot_r0_prompt,
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        required=True,
        help="Output cache directory used later by MagicBot_R0 training.",
    )
