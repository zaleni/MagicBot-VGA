...
POLICY="cubev2"
OLD_CHECKPOINT_DIR="${OLD_CHECKPOINT_DIR:-${CKPT_DIR:-${CHECKPOINT_DIR:-}}}"
...
OPTIMIZER_LR="${OPTIMIZER_LR:-${LR:-3.0e-5}}"
SCHEDULER_WARMUP_STEPS="${SCHEDULER_WARMUP_STEPS:-${WARMUP_STEPS:-800}}"
SCHEDULER_DECAY_STEPS="${SCHEDULER_DECAY_STEPS:-${DECAY_STEPS:-${STEPS}}}"
SCHEDULER_DECAY_LR="${SCHEDULER_DECAY_LR:-${DECAY_LR:-3.0e-6}}"
