...
WEIGHTED_TASK_STATS="${WEIGHTED_TASK_STATS:-false}"
...
NORM_STATS_PATH="${NORM_STATS_PATH:-${NORM_STATS_ROOT}/robochallenge_raw_aloha/${TASK_PRESET}/${ACTION_TYPE}/chunk${CHUNK_SIZE}_frame${FRAME_INTERVAL}/stats.json}"
...
python util_scripts/compute_norm_stats_robochallenge_raw_aloha.py "${ARGS[@]}"
