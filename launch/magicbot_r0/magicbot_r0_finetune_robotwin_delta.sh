...
RESUME="${RESUME:-true}"
RESUME_CHECKPOINT_DIR="${RESUME_CHECKPOINT_DIR:-/inspire/qb-ilm/project/embodied-basic-model/zhangjianing-253108140206/outputs/MagicBot_R0/magicbot_r0-robotwin-3d-delta-pretrained300k-finetune-2026_06_11_08_42_10/checkpoints/290000}"
