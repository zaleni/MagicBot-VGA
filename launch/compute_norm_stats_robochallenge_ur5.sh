...
NORM_STATS_PATH="${NORM_STATS_PATH:-${NORM_STATS_ROOT}/robochallenge_ur5/${ACTION_TYPE}/stats.json}"
REPO_ID_FILE="${REPO_ID_FILE:-${NORM_STATS_ROOT}/_repo_id_files/robochallenge_ur5_${ACTION_TYPE}.txt}"
