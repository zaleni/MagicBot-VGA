...
#   sbatch --array=0-3 launch/cubev2/cubev2_finetune_robotwin_slurm.sh
# Or run one case with:
#   ABLATION_ID=4 sbatch launch/cubev2/cubev2_finetune_robotwin_slurm.sh
...
LAUNCH_SCRIPT_PATH="${PROJ_ROOT}/launch/cubev2/cubev2_finetune_robotwin.sh"
