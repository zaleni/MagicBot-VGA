...
LAUNCH_SCRIPT_PATH="${PROJ_ROOT}/launch/cubev2/cubev2_finetune_real_lift2_abs.sh"
...
# Cluster-side training values forwarded to launch/cubev2/cubev2_finetune_real_lift2_abs.sh.
